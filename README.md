...
1. Сохранить `Animura.exe` из интересующей вас версии.
...
5. Установите значение предпоследнего параметра на название вашего медиа (или установите как абсолютный путь, в случае, если медиа по какой-либо причине находится не в одной директории с `Animura.exe`.
